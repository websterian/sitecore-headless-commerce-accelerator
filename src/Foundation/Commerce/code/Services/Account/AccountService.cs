...
namespace Wooli.Foundation.Commerce.Services.Account
{
    ...
    public class AccountService : IAccountService
    {
        ...
        public Result<ChangePasswordResultModel> ChangePassword(string email, string newPassword, string oldPassword)
        {
            throw new NotImplementedException();
        }

        public Result<CreateAccountResultModel> CreateAccount(
            string email,
            string firstName,
            string lastName,
            string password)
        ...
        public Result<CommerceUserModel> UpdateAccount(string contactId, string firstName, string lastName)
        {
            throw new NotImplementedException();
        }
        ...
        public Result<ValidateAccountResultModel> ValidateEmail(string email)
        {
            throw new NotImplementedException();
        }
    }
