...
namespace Wooli.Feature.Account.Tests.Controllers
{
    ...
    public class AccountsControllerTests
    {
        public AccountsControllerTests()
        {
            ...
            this.entityMapper = Substitute.For<IAccountEntityMapper>();
        ...
        public void AddAddress_ShouldCallExecuteMethod()
        {
            ...
            // assert
            this.controller.Received().Execute(Arg.Any<Func<Result<IEnumerable<Address>>>>());
        }
        ...
        public void ChangePassword_ShouldCallExecuteMethod()
        {
            ...
            // assert
            this.controller.Received().Execute(Arg.Any<Func<Result<ChangePasswordResultModel>>>());
        }
        ...
        public void CreateAccount_ShouldCallExecuteMethod()
        {
            ...
            // assert
            this.controller.Received().Execute(Arg.Any<Func<Result<CreateAccountResultModel>>>());
        }
        ...
        public void UpdateUser_ShouldCallExecuteMethod()
        {
            ...
            // assert
            this.controller.Received().Execute(Arg.Any<Func<Result<CommerceUserModel>>>());
        }
        ...
        public void ValidateAccount_ShouldCallExecuteMethod()
        {
            ...
            // assert
            this.controller.Received().Execute(Arg.Any<Func<Result<ValidateAccountResultModel>>>());
        }
    }
}